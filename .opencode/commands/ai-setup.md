...
2. .claude/skills/ — one skill per cross-cutting concern found in the codebase:
   ...
   - Focus on what the agent gets wrong without guidance, not obvious things
...
3. .claude/agents/ — one subagent per component in apps/:
   ...
   - description written so the agent auto-delegates correctly
...
5. AGENTS.md at project root
   ...
   - When to use /compact for this project
