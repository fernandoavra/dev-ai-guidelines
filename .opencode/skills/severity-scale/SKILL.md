---
name: severity-scale
description: Shared P0-P3 severity taxonomy used by all review agents (code-reviewer, security-reviewer, qa-engineer, hostile-reviewer, db-auditor, tech-debt-auditor) for consistent findings
license: MIT
